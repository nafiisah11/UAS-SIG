...
// inisialisasi model kecamatan dan kantor
...
class Dashboard extends BaseController
{
   ...
   public function index(){
       ...
       // inisiasi object dari class KantorModel
       $kantor = new KantorModel();
       // mengambil semua data kantor
       $query = $kantor->findAll();
       $lokasi = '';
       $label_lokasi='';
       // perulangan untuk mempersiapkan data marker
       foreach ($query as $data_kantor) {
           $lokasi .= '["'.$data_kantor->kode_pos.'" ,"'.$data_kantor->alamat_kantor.'",'.$data_kantor->koordinat.'],';
       }
       $data['marker'] = $lokasi;
